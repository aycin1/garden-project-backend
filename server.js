...
app.get("/shopping-list/:user", (req, res) => handleGetShopping.handleGetShopping(req, res, client));
...
app.post("/sign-up", (req, res) => handleRegisterUser.handleRegisterUser(req, res, client, hasher));
app.post("/login", (req, res) => handleLogin.handleLogin(req, res, client, uuid, hasher));
